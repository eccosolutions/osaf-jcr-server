...
public class ReportInfo implements XmlSerializable {
    ...
    public ReportInfo(Element reportElement, int depth) throws DavException {
        ...
        if (propElement != null) {
            ...
            // don't remove these elements since they may contain
            // children that are used by specific reports
    ...
    /**
     * XML element used to construct this info, if any.
     *
     * @return XML report element
     */
