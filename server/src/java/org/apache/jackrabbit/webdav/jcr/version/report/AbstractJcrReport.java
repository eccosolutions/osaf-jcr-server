 ...
 */
public abstract class AbstractJcrReport implements Report, XmlSerializable {
    ...
    /**
     * Run the report and send the response.
     **/
    public void run(DavServletResponse response)
        throws IOException, DavException {
        int statusCode = isMultiStatusReport() ?
            DavServletResponse.SC_MULTI_STATUS :
            DavServletResponse.SC_OK;
        response.sendXmlResponse(this, statusCode);
    }
}
