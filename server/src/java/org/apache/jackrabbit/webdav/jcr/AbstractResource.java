...
abstract class AbstractResource implements DavResource, ObservationResource,
    ...
    /**
     * @see org.apache.jackrabbit.webdav.DavResource#getETag()
     */
    ...
    /**
     * Set the etag field and add the {@link DavPropertyName#ETAG} property to the set of properties.
     */
    ...
    public void spool(OutputContext outputContext) throws IOException {
        ...
        if (etag != null) {
            setETag(String.valueOf(etag.getValue()));
